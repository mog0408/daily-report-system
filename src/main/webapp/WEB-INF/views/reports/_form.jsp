...
<label for="${AttributeConst.REP_BUSINESS.getValue()}">商談状況</label><br />
<textarea  name="${AttributeConst.REP_BUSINESS.getValue()}" id="${AttributeConst.REP_BUSINESS.getValue()}" rows="6" cols="50">${report.business}</textarea>
<br /><br />
